...
class FavoriteIfThenListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('お気に入りのIf-Then'),
        ...
        body: Consumer(
          builder: (context, watch, child) {
            final myFavoriteIfThenList =
                watch(favoriteIfThenProvider).favoriteIfThenList;
            final deleteController = watch(favoriteIfThenProvider);
            return ListView(
        ...
        floatingActionButton: Consumer(builder: (context, watch, child) {
          ...
          return FloatingActionButton(
            onPressed: () {
              //  ここでfavoriteIfThenListをプリントしてみる
              print(myFavoriteIfThenList[0]);
              //  printしてみたところ、myFavoriteIfThenListの中身はnull
            },
